...
name = u"design-proposal"
project = u"Go Design Proposal"
copyright = u""
author = u""
version = u""
release = version
...
latex_documents = [(
    master_doc, "{0}.tex".format(name), u"{0} Documentation".format(name),
    author, "manual")]

man_pages = [(
    master_doc, name, u"{0} Documentation".format(name), [author], 1)]

texinfo_documents = [(
    master_doc, name, u"{0} Documentation".format(name),
